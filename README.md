...
```
docker run --rm -it -v $(pwd):/python3-android -v /path/to/android-ndk:/android-ndk:ro --env ARCH=arm --env ANDROID_API=21 docker.io/library/python:3.9.5-slim /python3-android/docker-build.sh
```
